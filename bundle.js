...
/***/ function(module, exports, __webpack_require__) {
	...
	_fastclick2.default.attach(document.body, option);
	 ...
	 * @type {App}
	 */
	var app = new _app2.default(names, bigSizeNumber, sideIcons);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RootApp = __webpack_require__(229);
	...
	var App = function () {
	  function App(names, bigSizeNumber, sideIcons) {
	  ...
	  _createClass(App, [{
	    key: '_getSideIconFiles',
	    value: function _getSideIconFiles() {
	    ...
	    key: 'appGenerator',
	    value: function appGenerator() {
	      this._getSideIconFiles();
	      _reactDom2.default.render(_react2.default.createElement(_RootApp2.default, { names: this.names, sideIcons: this.sideIcons, sideIconFiles: this.sideIconFiles, bigSizeNumber: this.bigSizeNumber }), document.getElementById('main'));
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RootApp = function (_Component) {
	  _inherits(RootApp, _Component);

	  function RootApp(props) {
	    _classCallCheck(this, RootApp);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RootApp).call(this, props));

	    _this.state = {
	      names: typeof _this.props.names !== "undefined" && _this.props.names !== null ? _this.props.names : [],
	      sideIcons: typeof _this.props.sideIcons !== "undefined" && _this.props.sideIcons !== null ? _this.props.sideIcons : [],
	      bigSizeNumber: typeof _this.props.bigSizeNumber !== "undefined" && _this.props.bigSizeNumber !== null ? _this.props.bigSizeNumber : [],
	      sideIconFiles: typeof _this.props.sideIconFiles !== "undefined" && _this.props.sideIconFiles !== null ? _this.props.sideIconFiles : {}
	    };
	    return _this;
	  }
	  ...
	  _createClass(RootApp, [{
	    key: 'showBigPoker',
	    value: function showBigPoker(name, sideIcon) {
	      this.refs.bigPoker.show(name, sideIcon);
	    }
	  }, {
	    key: 'hideBigPoker',
	    value: function hideBigPoker() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BigPoker = function (_Component) {
	  _inherits(BigPoker, _Component);

	  function BigPoker(props) {
	    _classCallCheck(this, BigPoker);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BigPoker).call(this, props));
	  ...
	  _createClass(BigPoker, [{
	    ...
	    key: 'show',
	    value: function show(name, sideIcon) {
	    ...
	    key: 'resizeFrontFont',
	    value: function resizeFrontFont() {
	    ...
	    value: function render() {
	      ...
	      var bigPokerClassNames = (0, _classnames2.default)("show-big-poker", "poker-align", this.state.resizeFont);
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CloseButton = function (_Component) {
	  ...
	  function CloseButton(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CloseButton).call(this, props));
	  ...
	  _createClass(CloseButton, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { onClick: this.props.onClick, className: 'close-button' },
	        _react2.default.createElement(
	          'svg',
	          { viewBox: '0 0 100 100' },
	          _react2.default.createElement('circle', { cx: '100%', cy: '0', r: '100%', fill: 'gray', fillOpacity: '0.4' }),
	          _react2.default.createElement('circle', { cx: this.state.x1, cy: this.state.y1, r: this.state.radius, fill: 'white', fillOpacity: '1' }),
	          _react2.default.createElement('circle', { cx: this.state.x2, cy: this.state.y1, r: this.state.radius, fill: 'white', fillOpacity: '1' }),
	          _react2.default.createElement('circle', { cx: this.state.x3, cy: this.state.y1, r: this.state.radius, fill: 'white', fillOpacity: '1' }),
	          _react2.default.createElement('circle', { cx: this.state.x4, cy: this.state.y1, r: this.state.radius, fill: 'white', fillOpacity: '1' }),
	          _react2.default.createElement('circle', { cx: this.state.x1, cy: this.state.y2, r: this.state.radius, fill: 'white', fillOpacity: '1' }),
	          _react2.default.createElement('circle', { cx: this.state.x2, cy: this.state.y2, r: this.state.radius, fill: 'white', fillOpacity: '1' }),
	          _react2.default.createElement('circle', { cx: this.state.x3, cy: this.state.y2, r: this.state.radius, fill: 'white', fillOpacity: '1' }),
	          _react2.default.createElement('circle', { cx: this.state.x4, cy: this.state.y2, r: this.state.radius, fill: 'white', fillOpacity: '1' }),
	          _react2.default.createElement('circle', { cx: this.state.x1, cy: this.state.y3, r: this.state.radius, fill: 'white', fillOpacity: '1' }),
	          _react2.default.createElement('circle', { cx: this.state.x2, cy: this.state.y3, r: this.state.radius, fill: 'white', fillOpacity: '1' }),
	          _react2.default.createElement('circle', { cx: this.state.x3, cy: this.state.y3, r: this.state.radius, fill: 'white', fillOpacity: '1' }),
	          _react2.default.createElement('circle', { cx: this.state.x4, cy: this.state.y3, r: this.state.radius, fill: 'white', fillOpacity: '1' }),
	          _react2.default.createElement('circle', { cx: this.state.x1, cy: this.state.y4, r: this.state.radius, fill: 'white', fillOpacity: '1' }),
	          _react2.default.createElement('circle', { cx: this.state.x2, cy: this.state.y4, r: this.state.radius, fill: 'white', fillOpacity: '1' })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./CloseButton.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./CloseButton.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./BigPoker.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./BigPoker.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./RootApp.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./RootApp.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
